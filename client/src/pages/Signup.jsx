...
export default function Signup() {
    ...
    return (
        <div className="min-h-screen bg-[#fdfdfd] relative flex flex-col items-center justify-center p-6 font-sans selection:bg-yellow-200 overflow-hidden">
            ...
            <div className="absolute top-20 left-10 md:left-32 -rotate-12 opacity-20 hidden sm:block"><Palette size={52} strokeWidth={1.5} /></div>
            <div className="absolute bottom-20 right-10 md:right-32 rotate-12 opacity-20 hidden sm:block"><Rocket size={52} strokeWidth={1.5} /></div>
            <div className="absolute top-32 right-20 rotate-45 opacity-20 hidden md:block"><Star size={52} strokeWidth={1.5} /></div>
            ...
            <div className="w-full max-w-md bg-white border-2 border-black rounded-2xl shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] p-8 relative z-10 flex flex-col items-center rotate-1 hover:rotate-0 transition-transform duration-300">
                ...
                {/* Icon Header */}
                <div className="bg-green-300 border-2 border-black p-4 rounded-xl shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] -rotate-6 mb-6 hover:rotate-0 transition-transform">
                    <UserPlus size={36} strokeWidth={2.5} color="black" />
                </div>
                ...
                <form onSubmit={handleSubmit} className="w-full space-y-4">
                    ...
                    <div className="relative">
                        <User size={20} className="absolute left-4 top-1/2 -translate-y-1/2 text-gray-500" strokeWidth={2.5} />
                        <input
                            type="text"
                    ...
                    <button
                        type="submit"
                        disabled={isLoading}
                        className="w-full bg-purple-300 hover:bg-purple-400 text-black font-bold text-lg py-4 px-6 border-2 border-black rounded-xl flex items-center justify-center gap-3 shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] hover:translate-x-[2px] hover:translate-y-[2px] hover:shadow-[2px_2px_0px_0px_rgba(0,0,0,1)] active:shadow-none active:translate-x-[4px] active:translate-y-[4px] transition-all disabled:opacity-60 disabled:pointer-events-none -rotate-1"
                    >
                ...
                <div className="w-full relative flex items-center py-5 my-2">
                    ...
                    <span className="flex-shrink-0 mx-4 text-black font-bold px-4 py-1 bg-blue-200 border-2 border-black rounded-lg shadow-[2px_2px_0px_0px_rgba(0,0,0,1)] rotate-2 text-sm">
                        Already a member?
                    </span>
                    <div className="flex-grow border-t-2 border-black border-dashed"></div>
                </div>
